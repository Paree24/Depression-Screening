$(function(){
        ...
        var q = [
                ...
                },
                {
                    ...
                    'D':['Rarely', 'Sometimes', 'Not applicable to me', 'No', 'Often', 'Never', 'Yes'],
                ...
                },
                {
                    ...
                    'D':['Somewhat difficult', 'Somewhat easy', 'Neither easy nor difficult', "I don't know", 'Very easy', 'Difficult'],
                ...
                },
                {
                    ...
                    'D':['Yes, I have observed', 'No', 'Maybe/Not sure', 'Yes, I have experienced'],
                    'cname':'well_handled'
                },
                {
                    ...
                    'D':['No, none of my previous supervisors', 'Some of my previous supervisors', 'Yes, all of my previous supervisors'],
        ...
        for(var i=0;i<q[0].C.length;i++)
            ...
            <label for="f-option" class="element-animation">`+q[0].D[i]+`</label>
            <div class="check"></div>
            </li>`
            ...
            setTimeout(function(){
                ...
                if((questionNo + 1) > q.length){
                    ...
                    for(var i=0;i<q[questionNo].C.length;i++)
                        content=content+`<li>
                        <input type="radio" id="s-option" name="selector" value="`+(i+1)+`">
                        <label for="f-option" class="element-animation">`+q[questionNo].D[i]+`</label>
                        <div class="check"></div>
                        </li>`
                    options.innerHTML = content
                }
